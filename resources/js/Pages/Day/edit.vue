...
const form = useForm({
    _method: 'put',
    circuit_id: props.step.circuit_id,
    title: props.step.title,
    description: props.step.description,
    image: null,
    distance: props.step.distance,
    start: props.step.start,
    end: props.step.end,
    hotel_name: props.step.hotel_name,
    hotel_description: props.step.hotel_description,
    day: props.step.day
});

const submit = () => {
    form.post(route('days.update', props.step.id));
        ...
        <div class="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Step</h1>
